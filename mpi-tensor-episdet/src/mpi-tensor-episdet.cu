/**
 *
 * mpi-tensor-episdet: Multi-GPU and multi-node high-throughput high-order exhaustive epistasis detection using fused XOR+POPC binary matrix operations on NVIDIA GPU tensor cores
 *
