...
__global__ void combine(uint *datasetCases, uint *datasetControls, __half *cases_A_block16bit_ptrGPU, __half *controls_A_block16bit_ptrGPU, int numSNPs, int casesSizeOriginal, int controlsSizeOriginal, int startIndex_X, int startIndex_Y);

__global__ void applyScore_and_FindGloballyBestSol(float *C_ptrGPU_cases, float *C_ptrGPU_controls, float *C_ptrGPU_cases_XYZ, float *C_ptrGPU_controls_XYZ, float *C_ptrGPU_cases_WYZ, float *C_ptrGPU_controls_WYZ, float *C_ptrGPU_cases_WXY, float *C_ptrGPU_controls_WXY, uint * d_output_individualSNP_popcountsForCases, uint *d_output_individualSNP_popcountsForControls, uint* d_output_pairwiseSNP_popcountsForCases, uint* d_output_pairwiseSNP_popcountsForControls, float *tablePrecalc, float *output, unsigned long long int *output_packedIndices, int start_W, int start_X, int start_Y, int start_Z, int numSNPs, int numCases, int numControls);
